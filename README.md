...
- Hover-driven hero animation: Hokusai-style waves, flying gulls, breaching dolphins, and a sunrise-to-sunset sky cycle (pure CSS/SVG, respects reduced motion)
